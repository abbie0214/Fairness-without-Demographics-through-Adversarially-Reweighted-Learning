...
class CompasInput():
    ...
    def add_subgroups_to_targets(self, targets, all_features):
        ...
        sensitive_features = all_features[:,8]
        targets = np.insert(targets,-1,values = sensitive_features,axis = 1)

        sensitive_features = all_features[:,9]
        targets = np.insert(targets,-1,values = sensitive_features,axis = 1)
...
# print('############################################')
# print('train_features',train_features)   #5049x8
# print('train_features.shape',train_features.shape)
# print('train_targets',train_targets)#5049x3
# print('train_targets.shape',train_targets.shape)
#
# print('############################################')
# print('test_features',test_features)   #2165x8
# print('test_features.shape',test_features.shape)
# print('test_targets',test_targets)#2165x3
